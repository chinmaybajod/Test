...
void BinaryOperation::printInstruction()
{
    ...
    for (int i = 0; i < this->operands.size(); i++)
    {
        ...
        if (i != this->operands.size() - 1)
        {
            ...
            {
                case ADD:   llvm::outs() << " + "; stored_operator = " + ";
                            break;
                case SUB:   llvm::outs() << " - "; stored_operator = " - ";
                            break;
                case MUL:   llvm::outs() << " * "; stored_operator = " * ";
                            break;
                case DIV:   llvm::outs() << " / "; stored_operator = " / ";
                            break;
                case REM:   llvm::outs() << " % "; stored_operator = " % ";
                            break;
                            
                case SHIFT_LEFT:                llvm::outs() << " << "; stored_operator = " << ";
                                                break;
                case LOGICAL_SHIFT_RIGHT:       llvm::outs() << " >>> "; stored_operator = " >>> ";
                                                break;
                case ARITHMETIC_SHIFT_RIGHT:    llvm::outs() << " >> "; stored_operator = " >> ";
                                                break;
                case BITWISE_AND:               llvm::outs() << " & "; stored_operator = " & ";
                                                break;
                case BITWISE_OR:                llvm::outs() << " | "; stored_operator = " | ";
                                                break;
                case BITWISE_XOR:               llvm::outs() << " ^ "; stored_operator = " ^ ";
                                                break;
    ...
    llvm::outs() << "\t\tOPERATOR : " << stored_operator << " |\t OPERANDS : ";
    for (int i = 0; i < this->operands.size(); i++)
    {
        this->operands[i].first->printOperand(llvm::outs());
        llvm::outs() << " ";
